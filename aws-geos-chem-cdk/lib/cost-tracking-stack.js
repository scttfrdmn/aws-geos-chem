...
exports.CostTrackingStack = void 0;
...
class CostTrackingStack extends cdk.Stack {
    constructor(scope, id, props) {
        ...
        dailyCostUpdateLambda.addToRolePolicy(new iam.PolicyStatement({
        ...
        realTimeCostTrackerLambda.addToRolePolicy(new iam.PolicyStatement({
            effect: iam.Effect.ALLOW,
            actions: [
...
exports.CostTrackingStack = CostTrackingStack;
